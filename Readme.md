...
- [Deprecating a field](#deprecating-a-field)
...
to field attributes and it will become marked as deprecated in GraphQL documentation. You can validate schema on client 
